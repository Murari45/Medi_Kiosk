              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    ...
                    children: [
                      pw.Text(
                        'MediKiosk AI Smart Health Center',
                  ...
                  pw.BarcodeWidget(
                    ...
                    data: 'MEDIKIOSK_RX_${prescription.id}_ABHA',
                    width: 50,
                    height: 50,
                  ),
                ],
              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text('Generated by MediKiosk AI Kiosk System', style: const pw.TextStyle(fontSize: 8, color: PdfColors.grey600)),
